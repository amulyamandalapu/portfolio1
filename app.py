...
PORTFOLIO_ITEMS = [
    {
        ...
        'description': 'A full-featured e-commerce web application with product catalog, shopping cart, and checkout functionality.',
        'image': 'ecommerce.svg',
        'technologies': ['HTML', 'CSS', 'JavaScript', 'Web Development'],
        'github': 'https://github.com/amulyamandalapu/ecom-web'
    },
    {
        'id': 2,
        'title': 'Blog App using Tkinter',
        'description': 'A desktop application for blogging built with Python Tkinter GUI framework with create, read, update, and delete functionality.',
        'image': 'blog.svg',
        'technologies': ['Python', 'Tkinter', 'Desktop Application'],
        'github': 'https://github.com/amulyamandalapu/Tkinter-Project'
    },
    {
        'id': 3,
        'title': 'Titanic Survival Prediction',
        'description': 'A machine learning project predicting passenger survival on the Titanic using feature engineering and classification models.',
        'image': 'titanic.svg',
        'technologies': ['Python', 'Pandas', 'scikit-learn', 'Jupyter'],
        'github': 'https://github.com/amulyamandalapu/titanic-survival-prediction'
    }
]
...
def contact():
    ...
    if request.method == 'POST':
        name = request.form.get('Amulya Mandalapu')
        email = request.form.get('amulyamandalapu@gmail.com')
        phone = request.form.get('8897497013')
